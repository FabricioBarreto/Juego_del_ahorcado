...
/*Establece los valores por defecto para iniciar el juego*/
...
function inicioDelJuego() {
    ...
    /* Verifica que no haya una partida ya iniciada */
    if (juegoIniciado) {
        return;
    }
...
const btnAgregar = document.querySelector("#btn-agregar").addEventListener("click", function (event) {
